<?php
	...
	class SDA_SearchResults
	{
		 ...
		 */
		public function __construct($SDA, $options, $results)
		{
			$this->_SDA = $SDA;
		...
		{
			return $this->_SDA->createSearchQuery($this->_options);
		}
		/**
		...
		public function getPrevPageSearchQuery()
		{
			...
			return $this->_SDA->createSearchQuery($this->_options)->withPaging($this->getPageNumber() - 1, $this->_results['limit']);
		}
		/**
